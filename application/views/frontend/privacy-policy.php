      ...
      <div class="col-md-12 ">
        ...
        <div class="head-content-div ">
          ...
          <div class="text-white text-center">
            ...
            <h1 class="mb-3 text-center">Privacy Policy for All Star Technologies</h1>
...
<div class="container sec-tb-padding">
  ...
  <div class="row pb-2">
    ...
    <div class="col-md-12">
      ...
      <p>At AST Marketing one of our main priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by AST Marketing and how we use it.</p>
      ...
      <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
        to the information that they shared and/or collect in AST Marketing. This policy is not applicable to any
        information collected offline or via channels other than this website.</p>


      <h2 class="text-start">Consent</h2>
      <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

      <h2 class="text-start">Information we collect</h2>
      ...
      <h2 class="text-start">How we use your information</h2>
      ...
      <h2 class="text-start my-3">Log Files</h2>

      <p>AST Marketing follows a standard procedure of using log files. These files log visitors when they visit
      ...
      <h2 class="text-start my-3">Cookies and Web Beacons</h2>
    </div>

    <p>Like any other website, AST Marketing uses "cookies". These cookies are used to store information including
    ...
    <h2 class="text-start">Google DoubleClick DART Cookie</h2>
    <p>Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to
      our site visitors based upon their visit to www.website.com and other sites on the internet. </p>

    <h2 class="text-start">Advertising Partners Privacy Policies</h2>
    <p>You may consult this list to find the Privacy Policy for each of the advertising partners of AST Marketing.</p>

    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
      their respective advertisements and links that appear on AST Marketing, which are sent directly to users' browser.
    ...
    <p> Note that AST Marketing has no access to or control over these cookies that are used by third-party advertisers.
    </p>

    <h2 class="text-start">Third Party Privacy Policies</h2>
    <p>AST Marketing's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
    ...
    <h2 class="text-start">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
    ...
    <h2 class="text-start">GDPR Data Protection Rights</h2>
