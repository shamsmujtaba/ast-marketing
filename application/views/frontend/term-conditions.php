...
<div class="service-bg d-flex justify-content-center align-items-center">
      ...
      <div class="col-md-12 ">
        ...
        <div class="head-content-div ">
          ...
          <div class="text-white text-center">
            ...
            <h1 class="mb-3 text-center">Terms and Conditions</h1>
...
<div class="container sec-tb-padding">

  <div class="row pb-2">

    <div class="col-md-12">

      <p>Welcome to AST Marketing!</p>

      <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use AST Marketing
      ...
      <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
        ...
        Company's stated services, in accordance with and subject to, prevailing law of gb. Any use of the above
      ...
      <h2 class="text-start">Cookies</h2>
      <p>We employ the use of cookies. By accessing AST Marketing, you agreed to use cookies in agreement with the All
        Star Technologies's Privacy Policy.</p>
      ...
      <p>Unless otherwise stated, All Star Technologies and/or its licensors own the intellectual property rights for
        all material on AST Marketing. All intellectual property rights are reserved. You may access this from AST
        Marketing for your own personal use subjected to restrictions set in these terms and conditions.</p>

      <p>You must not:</p>
      <ul>

        <li>
          <p>Republish material from AST Marketing</p>
        </li>

        <li>
          <p>Sell, rent or sub-license material from AST Marketing</p>
        </li>
        <li>
          <p>Reproduce, duplicate or copy material from AST Marketing</p>
        </li>
        <li>
          <p>Redistribute content from AST Marketing</p>
        </li>

      </ul>

      <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the Free
      ...
      <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas of the website. All Star Technologies does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions of All Star Technologies,its agents
        and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, All Star Technologies shall not be liable for the Comments or for any
      ...
      <p>All Star Technologies reserves the right to monitor all Comments and to remove any Comments which can be
      ...
      <ul>
        ...
        <li>
          <p>The Comments do not invade any intellectual property right, including without limitation copyright, patent
            or
            trademark of any third party;</p>
        </li>

        <li>
          <p>The Comments do not contain any defamatory, libelous, offensive, indecent or otherwise unlawful material
      ...
      <p>You hereby grant All Star Technologies a non-exclusive license to use, reproduce, edit and authorize others to
        use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>

      <h2 class="text-start">Hyperlinking to our Content</h2>
      ...
      <ul>
        ...
        <li>
          <p>Online directory distributors may link to our Website in the same manner as they hyperlink to the Websites
            of other listed businesses; and</p>
        </li>

        <li>
          <p>System wide Accredited Businesses except soliciting non-profit organizations, charity shopping malls, and
            charity fundraising groups which may not hyperlink to our Web site.</p>
        </li>
      ...
      <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of All Star
        Technologies; and (d) the link is in the context of general resource information.</p>
      ...
      <p> If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
        you
        must inform us by sending an e-mail to All Star Technologies. Please include your name, your organization name,
      ...
      <ul>
        ...
        <li>
          <p>By use of any other description of our Website being linked to that makes sense within the context and
            format of content on the linking party's site.</p>
        </li>

      </ul>
      <p>No use of All Star Technologies's logo or other artwork will be allowed for linking absent a trademark license
        agreement.</p>

      <h2 class="text-start">iFrames</h2>
      ...
      <h2 class="text-start">Content Liability</h2>
      ...
      <h2 class="text-start">Reservation of Rights</h2>
      ...
      <h2 class="text-start">Removal of links from our website</h2>
